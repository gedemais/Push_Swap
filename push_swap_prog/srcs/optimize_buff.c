...
void	optimize_push(int *buff, int i, bool *changed)
{
...
void	optimize_swap(int *buff, int i, bool *changed)
{
...
void	optimize_rotate(int *buff, int i, bool *changed)
{
...
void	optimize_rrotate(int *buff, int i, bool *changed)
{
